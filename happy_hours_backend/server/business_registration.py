...
BUSINESS_IMAGES_DIR = "C:/xampp/htdocs/happy_hours_application/business_images"
...
OUTPUT_DIR = "C:/xampp/htdocs/happy_hours_application/output_html"  # Web serves from here
...
def generate_static_page(business_data, image_filename=None):
    ...
    try:
        ...
        image_html = ""
        if image_filename:
            image_url = f"http://localhost/happy_hours_application/business_images/{image_filename}"
        ...
        if file and file.filename:
            ...
            if allowed_file(file.filename):
                ...
                try:
                    ...
                    image_link_for_db = f"http://localhost/happy_hours_application/business_images/{uploaded_image_filename}"
