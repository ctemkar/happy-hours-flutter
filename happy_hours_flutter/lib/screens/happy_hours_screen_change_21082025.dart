                                  ...
                                  return ChoiceChip(
                                    ...
                                    onSelected: (_) {
                                      ...
                                      // 🔑 Fetch again with city + business category
                                       _setLocationAndFetch(selectedLocation, category);
                                    },
    ...
    itemBuilder: (context, index) {
      ...
      return ChoiceChip(
        ...
        onSelected: (_) {
          ...
          // 🔑 Fetch data with current city and selected business
          fetchHappyHours(
            city: selectedLocation, // always required
            business: selectedCategory, // "ALL" means no filter
          ).then((places) {
            setState(() {
              happyHourPlaces = places;
            });
          }).catchError((e) {
            setState(() {
