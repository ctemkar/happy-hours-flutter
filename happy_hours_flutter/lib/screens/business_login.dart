...
class _BusinessLoginPageState extends State<BusinessLoginPage> {
  ...
  Future<void> _login() async {
    ...
    final url = Uri.parse(
      "http://localhost:5000/business_login",
    );
...
Future<String> _loadHtml() async {
  ...
  try {
    final response = await http.post(
      Uri.parse("http://localhost:5000/get_business"),
      headers: {"Content-Type": "application/json"},
      body: jsonEncode({"business_name": widget.businessName}),
    );
  ...
  Future<void> _onDelete() async {
    ...
    try {
      final resp = await http.post(
        Uri.parse("http://localhost:5000/delete_business"),
        headers: {"Content-Type": "application/json"},
        body: jsonEncode({
...
''';
  ...
  Future<void> _save() async {
    ...
    try {
      final resp = await http.post(
        Uri.parse("http://localhost:5000/update_business"),
        headers: {"Content-Type": "application/json"},
